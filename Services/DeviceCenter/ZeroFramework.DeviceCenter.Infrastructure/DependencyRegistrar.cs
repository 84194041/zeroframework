...
namespace ZeroFramework.DeviceCenter.Infrastructure
{
    public static class DependencyRegistrar
    {
        public static IServiceCollection AddInfrastructureLayer(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                optionsBuilder.UseMySql(configuration.GetConnectionString(DbConstants.DefaultConnectionStringName), new MySqlServerVersion(new Version(8, 0, 21)), sqlOptions =>
                {
