...
namespace ZeroFramework.IdentityServer.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                optionsBuilder.UseMySql(Configuration.GetConnectionString("Default"), new MySqlServerVersion(new Version(8, 0, 21)), sqlOptions =>
                {
            ...
            #region Add IdentityServer Service
            ...
            services.AddIdentityServer()
                ...
                {
                    options.ConfigureDbContext = builder => builder.UseMySql(Configuration.GetConnectionString("Default"), new MySqlServerVersion(new Version(8, 0, 21)), sqlOptions =>
                    {
                        sqlOptions.MigrationsAssembly(Assembly.GetExecutingAssembly().GetName().Name);
